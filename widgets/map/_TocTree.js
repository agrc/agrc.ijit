dojo.provide("ijit.widgets.map._TocTree");
dojo.require("dijit.Tree");


dojo.declare("ijit.widgets.map._CheckBoxTreeNode", dijit._TreeNode, {
...
dojo.declare("ijit.widgets.map._TocTree", dijit.Tree, {
    _createTreeNode: function (args) {
        return new ijit.widgets.map._CheckBoxTreeNode(args);
    }
