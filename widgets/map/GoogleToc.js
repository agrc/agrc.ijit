dojo.provide("ijit.widgets.map.GoogleToc");
dojo.require("ijit.widgets.map._Toc");

dojo.declare("ijit.widgets.map.GoogleToc", ijit.widgets.map._Toc, {
    // description:
    ...
    //      </p>
    //      <p>
    //      **Test Page**: <a href='/tests/dojo/agrc/1.0/agrc/widgets/tests/GoogleTocTest.html'>ijit.widgets.map.GoogleTocTest.Test</a>
    //      </p>
    //      <p>
    //      **Description**: 
    ...
    //		</ul>
    //      example: 
    // |		var toc = new ijit.widgets.map.GoogleToc({  mapServiceLayer: dynamap }, dojo.byId("toc"));
