dojo.provide("ijit.widgets.map.Toc");
dojo.require("ijit.widgets.map._Toc");

dojo.declare("ijit.widgets.map.Toc", ijit.widgets.map._Toc, {
    // description:
    ...
    //      </p>
    //      <p>
    //      **Test Page**: <a href='/tests/dojo/agrc/1.0/agrc/widgets/tests/TOCTest.html' target='_blank'>ijit.widgets.map.TOCTest.Test</a>
    //      </p>
    //      <p>
    //      **Description**: 
    ...
    //		</ul>
    // example:
    // |	var = new ijit.widgets.map.Toc({ mapServiceLayer: dynamicLayer }, dojo.byId("Toc-div"));
    //
