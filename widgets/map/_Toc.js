...
dojo.provide("ijit.widgets.map._Toc");
dojo.require("ijit.widgets.map._TocTree");
...
dojo.declare("ijit.widgets.map._Toc", [dijit._Widget, dijit._Templated], {

    widgetsInTemplate: true,
    
    templateString: dojo.cache("ijit.widgets.map", "templates/Toc.html"),
    
    _treeStore: {},
    
    _populateTocServiceUrl: "http://mapserv.utah.gov/WSUT/Dojo.svc/PopulateTOC?serviceDefURL=",
    ...
    _makeTree: function(){
        ...
        var tocTree = new ijit.widgets.map._TocTree({ //dijit.Tree
            model: TOCTreeModel,
            persist: false,
            showRoot: false,
            openOnClick: true
